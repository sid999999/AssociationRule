...
Original file is located at
    https://colab.research.google.com/drive/1rUX4k8i3lxdRIsnAO117gNGvScFatSP2
...
Sort the rules by decreasing lift. where; 

Support(x) = (obs that contains x) / (all obs); 

Confidence(x-->y) = (obs that contain both x and y) / (obs that only contain x)
